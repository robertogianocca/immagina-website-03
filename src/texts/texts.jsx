export const Texts = (portfolioCultura) => {
  ...
  slava.shortDescription = (
    <div>
      <p>
        ...
        dall'artista russo Slava Polunin. Poesia sulle orme di Pushkin, Gogol, Chekhov, Kandinsky,
        Chagall, Eisenstein, Tarkovsky, Stravinsky, Prokofiev.
      </p>
    </div>
  );
  ...
  slava.longDescription = (
    <div>
      ...
      <p className="custom-indent">
        ...
        <span className="italic"> SnowShow</span> di Slava una esperienza indimenticabile. Le
        diverse scene rimangono impresse nella memoria: suscitano ilarità, stupore, sorrisi.
      </p>
      <p className="custom-indent">
  ...
  const dimitri = portfolioCultura["Photography"]["Teatro"]["Dimitri"].pictures[0];

  dimitri.shortDescription = (
    <div>
      <p>
        C’era simpatia, amicizia, fiducia. Dimitri, il nostro clown, accetta di buon grado di
        esibirsi in una performance davanti alla camera, senza pubblico, senza trucco, senza
        specchio. Improvvisa. E sul suo viso a far passare pensieri, emozioni, smorfie, clownerie.
      </p>
    </div>
  );

  dimitri.longDescription = (
    <div>
      <p>
        C’era simpatia, amicizia, fiducia. Dimitri, il nostro clown, accetta di buon grado di
        esibirsi in una performance davanti alla camera, senza pubblico, senza trucco, senza
      ...
      <p className="custom-indent">
        Nato ad Ascona 1935. Fondò il suo teatro a Verscio e visse con la moglie Gunda nelle
        Centovalli fino al suo ultimo giorno del 2016. Questa galleria propone immagini che sfuggono
        allo spettatore quando Dimitri calcava il palco di Verscio, e ovunque e per mezzo secolo.
        Questo quarto d’ora, con il quasi ottantenne artista, ha il pregio di mostrarci
        l’espressività e la padronanza del suo mestiere. Nudo tal qual è, qual è stato. Dimitri,
        amato mimo, amato clown. Oggi ci manchi.
      </p>
    </div>
  );
};
